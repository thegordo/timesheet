...
<div class="login">
    <form action="library/saveHourType.jsp" method="post" name="hourType">
        ...
        <input class="field" id="paid" name="<%=HourType.Field.paid%>" type="checkbox" <%=hourType == null || hourType != null && hourType.getPaid() ? "checked=\"yes\"" : ""%> />
        <br/>
        <label for="defaultFlag">Default:</label>
        <input class="field" id="defaultFlag" name="<%=HourType.Field.defaultFlag%>" type="checkbox" <%=hourType == null || hourType != null && hourType.getDefaultFlag() ? "checked=\"yes\"" : ""%> />
        <br/>
